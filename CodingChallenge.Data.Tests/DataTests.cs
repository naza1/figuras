...
namespace CodingChallenge.Data.Tests
{
    ...
    public class DataTests
    {
        ...
        {
            Assert.AreEqual("<h1>lista vazia</h1>",
        ...
        public void TestResumenListaConMasTipos()
        {
            var formas = new List<FormaGeometrica>
            {
                ...
                new Triangulo(FormaGeometrica.TrianguloEquilatero, 4),
                new Cuadrado(FormaGeometrica.Cuadrado, 2),
                new Triangulo(FormaGeometrica.TrianguloEquilatero, 9),
                new Circulo(FormaGeometrica.Circulo, 2.75m),
                new Triangulo(FormaGeometrica.TrianguloEquilatero, 4.2m)
            };
